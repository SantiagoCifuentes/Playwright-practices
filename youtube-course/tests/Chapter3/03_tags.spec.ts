...
test.describe('Smoking testing - grouping tests', () => {test('first test', { tag: '@smoke' }, async ({page}) => {
...
test.describe('Regresion testing - grouping tests', () => {test.skip('second test', async ({page}) => {
